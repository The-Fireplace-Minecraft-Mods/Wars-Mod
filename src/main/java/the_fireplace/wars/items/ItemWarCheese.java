...
public class ItemWarCheese extends ItemFood {
	...
	public ItemStack onItemUseFinish(ItemStack itemStack, World world, EntityLivingBase entityPlayer) {
		...
		entityPlayer.addPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE, 10 * 20, 6));
		entityPlayer.addPotionEffect(new PotionEffect(MobEffects.BLINDNESS, 10 * 20, 6));
