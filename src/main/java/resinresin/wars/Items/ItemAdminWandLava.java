...
public class ItemAdminWandLava extends Item {
	public ItemAdminWandLava() {
		super();
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
		if (!world.isRemote) {
			...
			EntityFallingBlock fireball2 = new EntityFallingBlock(world, 1, 1, 1, Blocks.lava.getDefaultState());
