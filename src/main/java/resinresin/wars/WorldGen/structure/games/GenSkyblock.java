...
public class GenSkyblock {
	...
	public GenSkyblock(EntityPlayer player, int i, int j, int k) {
		...
		player.worldObj.setTileEntity(new BlockPos(i + 3, j + 67, k + -2), chest2);
		TileEntityChest tileentitychest = (TileEntityChest)player.worldObj.getTileEntity(new BlockPos(i + 3, j + 67, k + -2));
		if (tileentitychest != null && tileentitychest.getSizeInventory() > 0) {
			...
			player.worldObj.setTileEntity(new BlockPos(i + 1, j + 1, k + 0), chest3);
			TileEntityChest tileentitychest1 = (TileEntityChest)player.worldObj.getTileEntity(new BlockPos(i + 1, j + 1, k + 0));
