...
public class ItemBattleBurgur extends ItemFood {
	...
	public ItemStack onItemUseFinish(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		entityPlayer.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 10 * 20, 6));
		entityPlayer.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 10 * 20, 1));
