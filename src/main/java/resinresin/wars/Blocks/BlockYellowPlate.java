...
public class BlockYellowPlate extends BlockPressurePlate {
	...
	public BlockYellowPlate(int par1, String par2Str, Material par3Material, EnumMobType par4EnumMobType) {
		...
		if (!var8.isEmpty()) {
			...
			while (var9.hasNext()) {
				...
				if (!var10.doesEntityNotTriggerPressurePlate()) {
					...
					if (boots != null && boots.itemID == WarsItems.yellowBoots.itemID) {
