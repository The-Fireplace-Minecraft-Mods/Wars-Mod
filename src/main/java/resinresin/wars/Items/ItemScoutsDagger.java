...
public class ItemScoutsDagger extends Item {
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
		...
		if (player instanceof EntityPlayerMP && !ItemArmorMod.fullEquiped(player, resinresin.wars.registry.WarsItems.scoutArmor)) {
			player.addChatMessage("\u00a74DONT CHEAT! \u00a72Wear The Scout Armour (which you must put on in survival)");
			stack.stackSize = 0;
