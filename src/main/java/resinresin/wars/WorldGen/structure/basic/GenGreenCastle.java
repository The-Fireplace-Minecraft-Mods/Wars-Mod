...
public class GenGreenCastle {
	...
	public GenGreenCastle(EntityPlayer player, int i, int j, int k) {
		...
		warsmod.generateBlock(player.worldObj, i - 4, j + 13, k - 11, cloth);
		warsmod.generateBlock(player.worldObj, i + 15, j + 13, k - 11, cloth);

		warsmod.generateBlock(player.worldObj, i + 12, j + 15, k - 8, cloth);
		warsmod.generateBlock(player.worldObj, i - 7, j + 15, k - 8, cloth);

		warsmod.generateBlock(player.worldObj, i + 15, j + 13, k + 7, cloth);
		warsmod.generateBlock(player.worldObj, i - 4, j + 13, k + 7, cloth);

		warsmod.generateBlock(player.worldObj, i + 12, j + 15, k + 10, cloth);
		warsmod.generateBlock(player.worldObj, i - 7, j + 15, k + 10, cloth);
